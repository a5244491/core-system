...
describe Engine::POS::MembersAPI do
  ...
  describe 'register new member' do
     it 'should not register new member if mobile number is invalid' do
       post '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '1111', bank_card: '6225751111111111111'}, platform_account_header
     ...
     it 'should not register new member if bank_card is missing' do
       post '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '1111'}, platform_account_header
       response.status.should be == 400
     end

     it 'should not register new member if mobile is missing' do
       post '/engine/pos/members', {merchant_num: @store.merchant_number, bank_card: '6225751111111111111'}, platform_account_header
       response.status.should be == 400
     end
     ...
     it 'should register new member' do
       ...
       post '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '13981842941', bank_card: '6225751111111111111'}, platform_account_header
     ...
     it 'should not register new user if mobile is taken' do
       ...
       post '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '1234', bank_card: '4321111111111111111111'}, platform_account_header
       response.status.should be == 419
       body = JSON.parse(response.body)
     ...
     it 'should not register new user if bank_card is taken' do
       ...
       post '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '13981842941', bank_card: '4321111111111111111111'}, platform_account_header
       response.status.should be == 419
       body = JSON.parse(response.body)
     ...
     it 'should not register new user if bank_card num is too short' do
       post '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '13981842941', bank_card: '432111111'}, platform_account_header
       response.status.should be == 419
       body = JSON.parse(response.body)
  ...
  describe 'bind new card' do
    ...
    it 'should bind new card if bank_card is missing' do
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '1111'}, platform_account_header
      response.status.should be == 400
    end

    it 'should not bind new card if mobile is missing' do
      put '/engine/pos/members', {merchant_num: @store.merchant_number, bank_card: '6225751111111111111'}, platform_account_header
      response.status.should be == 400
    end
    it 'should bind new card' do
      ...
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: @account.mobile, bank_card: '6225751111111111111'}, platform_account_header
      response.status.should be == 200
      body = JSON.parse(response.body)
    ...
    it 'should bind 2 cards' do
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: @account.mobile, bank_card: '6225751111111111111'}, platform_account_header
      response.status.should be == 200
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: @account.mobile, bank_card: '6225751111111111112'}, platform_account_header
      response.status.should be == 200
    ...
    it 'should bind new card for unknown bank' do
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: @account.mobile, bank_card: '1234567890123456'}, platform_account_header
      response.status.should be == 200
      body = JSON.parse(response.body)
      body['receipt']['transaction_type'].should be == MessageProperties::TRAN_TYPE_NEW_CARD
      body['receipt']['footer_m'].should_not be_nil
    ...
    it 'should not bind new card if member not registered' do
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '13981842940', bank_card: '4321111111111111111111'}, platform_account_header
      response.status.should be == 419
      body = JSON.parse(response.body)
    ...
    it 'should not bind new card mobile is not valid' do
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: '1', bank_card: '4321111111111111111111'}, platform_account_header
      response.status.should be == 419
      body = JSON.parse(response.body)
      body['screen_msg'].should be == MessageProperties::INVALID_MOBILE
    ...
    it 'should not bind new card if max card number exceeds' do
      ...
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: @account.mobile, bank_card: '4321111111111111111111'}, platform_account_header
      response.status.should be == 419
      body = JSON.parse(response.body)
    ...
    it 'should not bind new card if bank_card num is too short' do
      put '/engine/pos/members', {merchant_num: @store.merchant_number, mobile: @account.mobile, bank_card: '432111'}, platform_account_header
      response.status.should be == 419
      body = JSON.parse(response.body)
      body['screen_msg'].should be == MessageProperties::WRONG_BANK_CARD_NUM
    end
  ...
  describe 'query member card' do
    ...
    it 'should return query result for member card' do
      get '/engine/pos/members', {merchant_num: @store.merchant_number, bank_card: '4321111111111111111111'}, platform_account_header
      response.status.should be == 200
      body = JSON.parse(response.body)
    ...
    it 'should return query result for none member card' do
      get '/engine/pos/members', {merchant_num: @store.merchant_number, bank_card: '1111111111'}, platform_account_header
      response.status.should be == 200
      body = JSON.parse(response.body)
    ...
    it 'should return error missing bank_card parameter' do
      get '/engine/pos/members', {merchant_num: @store.merchant_number}, platform_account_header
      response.status.should be == 400
    end
  end
end