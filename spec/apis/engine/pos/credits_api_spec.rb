...
describe Engine::POS::CreditsAPI do
  ...
  it 'should return correct credit' do
    ...
    get '/engine/pos/credits', {merchant_num: @store.merchant_number, bank_card: '4321111111111111111111'}, platform_account_header
  ...
  it 'should not return correct credit if bank_card is missing' do
    @account.apply_consumption_credit!(1000, '4321111111111111111111')
    get '/engine/pos/credits', {merchant_num: @store.merchant_number}, platform_account_header
    response.status.should be == 400
  end

  it 'should not return credit for non member' do
    get '/engine/pos/credits', {merchant_num: @store.merchant_number, bank_card: '111111111111'}, platform_account_header
